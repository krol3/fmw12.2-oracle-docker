WLHOME      = '/u01/oracle/fmw12.2/wlserver'

DOMAIN      = 'soa_domain'
DOMAIN_PATH = '/u01/oracle/wlsdomains/domains/soa_domain'
APP_PATH    = '/u01/oracle/wlsdomains/applications/soa_domain'

SERVER_ADDRESS = '0.0.0.0'
LOG_FOLDER     = '/u01/oracle/log/weblogic/'
...
SOA_REPOS_DBURL          = 'jdbc:oracle:thin:@localhost:1521/soarepos.example.com'
